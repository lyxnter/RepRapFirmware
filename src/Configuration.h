...
constexpr float DefaultBedTemperatureLimit = 150.0;		// Celsius - lynxmod
...
constexpr size_t NumChamberHeaters = 2; // lynxmod
...
// Webserver stuff
#define DEFAULT_PASSWORD		"lynxters600d"				// Default machine password lynxmod
#define DEFAULT_MACHINE_NAME	"LYNXTER S600D"				// Default machine name lynxmod
...
#define LOGS_DIR "0:/logs/"							// Directory for logs

#define CONFIG_FILE "config.g"
#define DEFAULT_FILE "default.g"
#define DEFAULT_LOG_FILE "eventlog.txt"				// lynxmod deprecated
