...
const Pin LYNXMOD_TX = 24; 	// 24 lynxmod test //////////////////////////////////////////////////////////////////////////////////////////////
const Pin INPUT_DOOR_BP = 98;
const Pin DOOR_CMD = 43;
const Pin INPUT_DOOR_STATE = 99;
const Pin SAFETY_LED = 40;
...
//-------------------------------------------------------------------------------------------------------------
	...
	unsigned char LynxGCode;
		...
		unsigned int doorFan = 5;
		unsigned int filtrationFan = 2;
		...
		void Lock(bool cmd);
		void LynxInit();
		uint8_t GetIpAddress() const { return *ipAddress; }
	//#endif
